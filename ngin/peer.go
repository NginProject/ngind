...
// PeerInfo represents a short summary of the Ngin sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Ngin protocol version negotiated
...
// Handshake executes the ngin protocol handshake, negotiating version number,
