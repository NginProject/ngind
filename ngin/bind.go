...
// ContractBackend implements bind.ContractBackend with direct calls to Ngin
// internals to support operating on contracts within subprotocols like ngin and
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the Ngin
...
// ContractCall implements bind.ContractCaller executing an Ngin contract
