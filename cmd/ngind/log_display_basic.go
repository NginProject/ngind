...
func calcBlockDiff(e *ngin.Ngin, lastLoggedBlockN uint64, localHead *types.Block) (blks, txs, mgas int) {
...
var PrintStatusBasic = func(e *ngin.Ngin, tickerInterval time.Duration, insertEvent *core.ChainInsertEvent, maxPeers int) uint64 {
