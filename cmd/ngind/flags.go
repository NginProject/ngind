...
var (
	...
	SputnikVMFlag = cli.BoolFlag{
		Name:  "sputnikvm",
		Usage: "Use SputnikVM Ngin Virtual Machine implementation",
	}
	...
	ChainIdentityFlag = cli.StringFlag{
		Name:  "chain",
		Usage: `Chain identifier (default='mainnet', test='testnet') or path to JSON chain configuration file (eg './path/to/chain.json').`,
		Value: core.DefaultConfigMainnet.Identity,
	}
	NetworkIdFlag = cli.IntFlag{
		Name:  "network-id, networkid",
		Usage: "Network identifier (integer: 1=Homestead, 2=Testnet)",
		Value: ngin.NetworkId,
	}
	TestNetFlag = cli.BoolFlag{
		Name:  "testnet",
		Usage: "[Use: --chain=testnet] Testnet network: pre-configured test network with modified starting nonces (replay protection)",
	}
	...
	VModuleFlag = cli.StringFlag{
		Name:  "vmodule",
		Usage: "Per-module verbosity: comma-separated list of <pattern>=<level> (e.g. ng/*=6,p2p=5)",
		Value: "",
	}
