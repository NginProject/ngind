		...
		Subcommands: []cli.Command{
			{
				Action: importWallet,
				Name:   "import",
				Usage:  "import ng wallet",
			},
		},
		Description: `

ngind wallet import /path/to/my.wallet
	...
	'$ ngind account <command> --help' shows help for any subcommand.
...
ngind account list
	...
	Lists all accounts found in ngind's keystore.
...
ngind account new
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		ngind --password <passwordfile> account new
...
ngind account update <address>
	...
	For non-interactive use the passphrase can be specified with the --password flag:
		...
		ngind --password <passwordfile> account update <address>
...
ngind account import <keyfile>
	...
	For non-interactive use the passphrase can be specified with the -password flag:
		...
		ngind --password <passwordfile> account import <keyfile>
