...
const (
	...
	MetadataApi     = "rpc"
	DefaultIPCApis  = "admin,debug,ngin,miner,net,personal,shh,txpool,web3,ngind"
	DefaultHTTPApis = "ngin,net,web3"
)
...
func (s *Server) readRequest(codec ServerCodec) ([]*serverRequest, bool, RPCError) {
	...
	for i, r := range reqs {
		...
		if r.isPubSub { // ngin_subscribe, r.method contains the subscription method name
