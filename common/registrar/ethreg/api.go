...
import (
	...
	"github.com/NginProject/ngind/common/registrar"
...
func NewPrivateRegistarAPI(config *core.ChainConfig, bc *core.BlockChain, chainDb ngindb.Database, txPool *core.TxPool, am *accounts.Manager) *PrivateRegistarAPI {
