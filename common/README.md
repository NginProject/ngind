...
[![Build
Status](https://travis-ci.org/NginProject/ngind.png?branch=master)](https://travis-ci.org/NginProject/ngind)

The common package contains the ethereum utility library.

# Installation

As a subdirectory the main ngind repository, you get it with
