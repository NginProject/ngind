...
type Sync struct {
	database ngindb.Database          // Persistent database to check for existing entries
...
func NewTrieSync(root common.Hash, database ngindb.Database, callback LeafCallback) *Sync {
	ts := &Sync{
		database: database,
