...
func GetCanonicalHash(db ngindb.Database, number uint64) common.Hash {
...
func GetHeadHeaderHash(db ngindb.Database) common.Hash {
...
func GetHeadBlockHash(db ngindb.Database) common.Hash {
...
func GetHeadFastBlockHash(db ngindb.Database) common.Hash {
...
func GetHeaderRLP(db ngindb.Database, hash common.Hash) rlp.RawValue {
...
// found.
func GetHeader(db ngindb.Database, hash common.Hash) *types.Header {
...
func GetBodyRLP(db ngindb.Database, hash common.Hash) rlp.RawValue {
...
func GetBody(db ngindb.Database, hash common.Hash) *types.Body {
...
// none found.
func GetTd(db ngindb.Database, hash common.Hash) *big.Int {
...
func GetBlock(db ngindb.Database, hash common.Hash) *types.Block {
...
func GetBlockReceipts(db ngindb.Database, hash common.Hash) types.Receipts {
...
func GetTransaction(db ngindb.Database, hash common.Hash) (*types.Transaction, common.Hash, uint64, uint64) {
...
func GetReceipt(db ngindb.Database, txHash common.Hash) *types.Receipt {
...
func WriteCanonicalHash(db ngindb.Database, hash common.Hash, number uint64) error {
...
func WriteHeadHeaderHash(db ngindb.Database, hash common.Hash) error {
...
func WriteHeadBlockHash(db ngindb.Database, hash common.Hash) error {
...
func WriteHeadFastBlockHash(db ngindb.Database, hash common.Hash) error {
...
func WriteHeader(db ngindb.Database, header *types.Header) error {
...
func WriteBody(db ngindb.Database, hash common.Hash, body *types.Body) error {
...
func WriteTd(db ngindb.Database, hash common.Hash, td *big.Int) error {
...
func WriteBlock(db ngindb.Database, block *types.Block) error {
...
func WriteBlockReceipts(db ngindb.Database, hash common.Hash, receipts types.Receipts) error {
...
func WriteTransactions(db ngindb.Database, block *types.Block) error {
	batch := db.NewBatch()
...
func WriteReceipts(db ngindb.Database, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func DeleteBlockReceipts(db ngindb.Database, hash common.Hash) {
	db.Delete(append(blockReceiptsPrefix, hash.Bytes()...))
}

// DeleteTransaction removes all transaction data associated with a hash.
func DeleteTransaction(db ngindb.Database, hash common.Hash) {
...
func DeleteReceipt(db ngindb.Database, hash common.Hash) {
	db.Delete(append(receiptsPrefix, hash.Bytes()...))
}

// PreimageTable returns a Database instance with the key prefix for preimage entries.
func PreimageTable(db ngindb.Database) ngindb.Database {
	return ngindb.NewTable(db, preimagePrefix)
}

// WritePreimages writes the provided set of preimages to the database. `number` is the
// current block number, and is used for debug messages only.
func WritePreimages(db ngindb.Database, number uint64, preimages map[common.Hash][]byte) error {
...
func WriteTxLookupEntries(db ngindb.Putter, block *types.Block) error {
...
// network transitions to ngin/63.
func GetBlockByHashOld(db ngindb.Database, hash common.Hash) *types.Block {
...
// MIP bloom bin.
func WriteMipmapBloom(db ngindb.Database, number uint64, receipts types.Receipts) error {
	batch := db.NewBatch()
...
func GetMipmapBloom(db ngindb.Database, number, level uint64) types.Bloom {
	bloomDat, _ := db.Get(mipmapKey(number, level))
	return types.BytesToBloom(bloomDat)
}

// GetBlockChainVersion reads the version number from db.
func GetBlockChainVersion(db ngindb.Database) int {
	var vsn uint
...
func WriteBlockChainVersion(db ngindb.Database, vsn int) {
